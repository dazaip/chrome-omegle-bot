...
(function (ElementIds) {
    ElementIds["START"] = "start-bot-button";
    ElementIds["STOP"] = "stop-bot-button";
    ElementIds["SENT_TEXT"] = "bot-sent-text";
    ElementIds["STATUS"] = "bot-run-status";
...
const text = (text, id, extraStyles) => {
    const styles = Object.assign({ 'font-size': 'clamp(20px, 1.5vw, 30px)' }, extraStyles);
